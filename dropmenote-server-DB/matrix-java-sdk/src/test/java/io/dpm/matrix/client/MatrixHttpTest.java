...
public class MatrixHttpTest {
    ...
    protected MatrixIDImpl user = MatrixIDImpl.asAcceptable(username, domain);
    ...
    public void login() throws URISyntaxException {
        ...
        if (configFile != null) {
            MatrixHomeserverImpl homeserver = new MatrixHomeserverImpl(domain, baseUrl);
    ...
    protected InputStream readConfigFile() {
        ...
        if (configFile != null) {
            try (BufferedReader buffer = new BufferedReader(new InputStreamReader(configFile))) {
                ...
                user = new MatrixIDImpl(username, domain);
            } catch (IOException e) {
