...
import io.dpm.matrix.json.event.MatrixJsonRoomCanonicalAliasEvent;
...
public class MatrixJsonRoomCanonicalAliasEventTest {
    ...
    private final MatrixID userId = MatrixIDImpl.from("user", "example.org").valid();

    private MatrixJsonRoomCanonicalAliasEvent makeEvent(JsonObject content) {
        JsonObject obj = new JsonObject();
        obj.addProperty(EventKey.Type.get(), RoomCanonicalAliasEvent.Type);
