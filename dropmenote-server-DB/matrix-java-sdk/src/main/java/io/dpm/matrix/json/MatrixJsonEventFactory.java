...
import io.dpm.matrix.event.api.RoomCanonicalAliasEvent;
import io.dpm.matrix.event.api.TagsEvent;
import io.dpm.matrix.json.event.*;
import io.dpm.matrix.event.*;
import io.dpm.matrix.json.event.*;
...
public class MatrixJsonEventFactory {
    ...
    public static MatrixEvent get(JsonObject obj) {
        ...
        } else if (RoomCanonicalAliasEvent.Type.contentEquals(type)) {
        ...
        } else if (TagsEvent.Type.contentEquals(type)) {
            return new MatrixJsonRoomTagsEvent(obj);
        } else if (DirectEvent.Type.contentEquals(type)) {
