...
import io.dpm.matrix.event.api.RoomHistoryVisibilityEvent;
import io.dpm.matrix.json.MatrixJsonObject;

public class MatrixJsonRoomHistoryVisibilityEvent extends MatrixJsonRoomEvent implements RoomHistoryVisibilityEvent {
