...
public class RoomCreationOptionsImpl implements RoomCreationOptions {

    public static class Builder {

        private RoomCreationOptionsImpl obj;

        public Builder() {
            this.obj = new RoomCreationOptionsImpl();
        }
        ...
        public Builder setInvites(Set<MatrixID> invites) {
        ...
        public RoomCreationOptionsImpl get() {
            return obj;
        }
    }
    ...
    public static RoomCreationOptionsImpl none() {
        return build().get();
    }
    ...
    private Set<MatrixID> invites = new HashSet<>();
