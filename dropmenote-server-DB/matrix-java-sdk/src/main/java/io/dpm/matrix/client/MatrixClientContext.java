...
public class MatrixClientContext {
    ...
    public MatrixClientContext(MatrixHomeserver hs) {
        setDomain(hs.getDomain());
        setHsBaseUrl(hs.getBaseEndpoint());
    }

    public MatrixClientContext(MatrixHomeserver hs, MatrixID user, String token) {
        this(hs);
        setUser(user);
        setToken(token);
    }
    ...
    public MatrixHomeserver getHomeserver() {
        ...
        return new MatrixHomeserverImpl(domain, hsBaseUrl.toString());
    }
    ...
    public MatrixClientContext setUser(MatrixID user) {
        this.user = user;
        return this;
    }

    public MatrixClientContext setUserWithLocalpart(String localpart) {
        setUser(MatrixIDImpl.asAcceptable(localpart, getDomain()));
        return this;
    }
