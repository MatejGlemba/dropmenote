...
/**
 * AesCipher
 * <p>Encode/Decode text by password using AES-256-CBC algorithm</p>
 *
 * @author demisang, phu (Starbug s.r.o. | https://www.starbug.eu)
 * @link https://gist.github.com/demisang/716250080d77a7f65e66f4e813e5a636
 */
public class AESCipher {
    ...
    public static AESCipher decrypt(String secretKey, String cipherText) {
        try {
            ...
            String result = new String(cipher.doFinal(encrypted, INIT_VECTOR_LENGTH, encrypted.length - INIT_VECTOR_LENGTH), "UTF-8");

            // Return successful decoded object
            return new AESCipher(bytesToHex(ivParameterSpec.getIV()), result, null);
        } catch (Throwable t) {
            t.printStackTrace();
            //ZLE LOGOVANIE EXCEPTION
            // Operation failed
